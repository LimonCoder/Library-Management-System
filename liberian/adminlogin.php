...
if (isset($_POST['Submit'])){
    ...
    if (count($signin_errors) == 0){
        $query1 = "SELECT * FROM liberian WHERE Email = '$email' OR Username = '$email'";
        ...
        $query2 = "SELECT liberian.Password FROM liberian WHERE Email = '$useremail' OR Username = '$username' ";
